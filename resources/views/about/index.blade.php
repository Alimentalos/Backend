            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <a href="/about/documentation/introduction" class="btn btn-md btn-primary" role="button" aria-pressed="true">{{ __('Introduction') }}</a>
                        <hr>
                        <a href="/about/documentation/problem-and-solution" class="btn btn-md btn-light" role="button" aria-pressed="true">{{ __('Problem and solution') }}</a>
                        <a href="/about/documentation/actors-and-resources" class="btn btn-md btn-light" role="button" aria-pressed="true">{{ __('Actors and resources') }}</a>
                        <a href="/about/documentation/terms" class="btn btn-md btn-light" role="button" aria-pressed="true">{{__('Terms')}}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-8 mt-4">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <a href="/about/developer-handbook" class="btn btn-md btn-primary" role="button" aria-pressed="true">{{__('Get started') }}</a>
                        <a href="/api/documentation" class="btn btn-md btn-secondary" role="button" aria-pressed="true">OpenApi</a>
                        <hr>
